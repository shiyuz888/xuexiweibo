...
class PasswordController extends Controller
{
    ...
    {
        return view('password_reset.password-reset-request');
    }
    ...
    public function password_reset_email(Request $request)
    {
        ...
        // 4. 生成 Token，会在视图 confirm_email.password-reset-email 里拼接链接
        ...
        // 6. 将 Token 链接发送给用户
        Mail::send('confirm_email.password-reset-email', compact('token'), function ($message) use ($email) {
    ...
    public function password_reset_token(Request $request)
    {
        ...
        return view('password_reset.password-reset', compact('token'));
    }
